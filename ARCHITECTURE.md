...
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌─────────────────┐│ │
│  │  │                  │  │                  │  │                 ││ │
│  │  │ Formula          │  │ Time Series      │  │ Calculation     ││ │
│  │  │ Endpoints        │  │ Endpoints        │  │ Endpoints       ││ │
│  │  │                  │  │                  │  │                 ││ │
│  │  │ • submit_formula │  │ • submit_ts      │  │ • execute_calc  ││ │
│  │  │ • list_formulas  │  │ • list_ts        │  │ • get_calc_result││ │
│  │  │ • get_formula    │  │ • get_ts         │  │                 ││ │
│  │  │ • delete_formula │  │                  │  │                 ││ │
│  │  │                  │  │                  │  │                 ││ │
│  │  └────────┬─────────┘  └────────┬─────────┘  └────────┬────────┘│ │
...
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌────────────────┐│ │
│  │  │                  │  │                  │  │                ││ │
│  │  │ Formula Service  │  │ TimeSeries       │  │ Calculation    ││ │
│  │  │                  │  │ Service          │  │ Service        ││ │
│  │  │ • validate       │  │ • validate       │  │ • orchestrate  ││ │
│  │  │ • store          │  │ • store          │  │ • execute      ││ │
│  │  │ • retrieve       │  │ • retrieve       │  │                ││ │
│  │  │                  │  │                  │  │                ││ │
│  │  └────────┬─────────┘  └────────┬─────────┘  └────────┬───────┘│ │
...
│  │  ┌──────────────┐   ┌──────────────┐   ┌──────────────┐         │ │
│  │  │              │   │              │   │              │         │ │
│  │  │ Formula      │   │ TimeSeries   │   │ Calculation  │         │ │
...
│  │  │  Routes:                                                       │ │ │
│  │  │  • /             → Dashboard                                  │ │ │
│  │  │  • /builder      → Formula Builder (MSB Sender)               │ │ │
│  │  │  • /receiver     → Formula Receiver (NB Empfänger)            │ │ │
...
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌─────────────────┐  │ │
│  │  │                  │  │                  │  │                 │  │ │
│  │  │ Dashboard        │  │ Formula Builder  │  │ Formula Receiver│  │ │
│  │  │ Component        │  │ Component        │  │ Component       │  │ │
│  │  │                  │  │                  │  │                 │  │ │
│  │  │ • Health Status  │  │ • Template Sel.  │  │ • Formula List  │  │ │
│  │  │ • Statistics     │  │ • Form Editor    │  │ • Validation    │  │ │
│  │  │ • Quick Actions  │  │ • Preview        │  │ • Acceptance    │  │ │
│  │  │                  │  │ • Submit         │  │                 │  │ │
│  │  └────────┬─────────┘  └────────┬─────────┘  └────────┬────────┘  │ │
│  │           │                     │                     │           │ │
│  │           └─────────────────────┴─────────────────────┘           │ │
...
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐            │ │
│  │  │              │  │              │  │              │            │ │
│  │  │ FormulaCard  │  │ DetailModal  │  │ Validation   │            │ │
...
│  │  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐            │ │
│  │  │              │  │              │  │              │            │ │
│  │  │ Navigation   │  │ LoadingSpinner│ │ ErrorBoundary│            │ │
│  │  │ Component    │  │              │  │              │            │ │
│  │  │              │  │              │  │              │            │ │
│  │  └──────────────┘  └──────────────┘  └──────────────┘            │ │
│  │                                                                     │ │
...
│  │  │  ┌────────────────┐  ┌────────────────┐  ┌────────────────┐ ││   │
│  │  │  │                │  │                │  │                │ ││   │
│  │  │  │ formulaApi     │  │ timeSeriesApi  │  │ calculationApi │ ││   │
│  │  │  │                │  │                │  │                │ ││   │
...
│  │  │  │                   Axios HTTP Client                    │    ││   │
│  │  │  │                                                         │    ││   │
│  │  │  │  Base URL: http://localhost:8000 (via /api proxy)     │    ││   │
...
│  │  ┌──────────────────┐  ┌──────────────────┐  ┌────────────────┐ │     │
│  │  │                  │  │                  │  │                │ │     │
│  │  │ Formula Types    │  │ TimeSeries Types │  │ Template Data  │ │     │
│  │  │ (formula.ts)     │  │ (formula.ts)     │  │ (templates.ts) │ │     │
│  │  │                  │  │                  │  │                │ │     │
│  │  │ • Formula        │  │ • TimeSeries     │  │ • 5 Templates  │ │     │
│  │  │ • Expression     │  │ • Interval       │  │ • Function     │ │     │
│  │  │ • Parameter      │  │ • Period         │  │   Descriptions │ │     │
│  │  │ • 11 Functions   │  │                  │  │                │ │     │
│  │  │                  │  │                  │  │                │ │     │
│  │  └──────────────────┘  └──────────────────┘  └────────────────┘ │     │
│  │                                                                    │     │
